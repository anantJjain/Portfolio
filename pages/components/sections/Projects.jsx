                ...
                Project.map( (project) => {
                  return(
                    <motion.a 
                      ...
                      target="_blank"
                    >
                      <span className="z-10 w-full p-2 text-2xl font-bold tracking-tighter text-center text-white lg:text-3xl bg-black/30 backdrop-blur-sm md:text-xl sm1:text-lg">{project.name}</span>
                      <span className="z-10 w-full p-2 pt-0 font-thin text-center text-white lg:text-sm bg-black/30 backdrop-blur-sm sm1:text-xs">{project.desc}</span>
                    </motion.a>  
                  )
                }) 
              }
