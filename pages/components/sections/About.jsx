...
import animationData2 from "../../../public/media/lotties/sphere.json";
...
const About = () => {
    ...
    return (
        ...
        <div className='bg-[#000] text-white'>
            ...
            {/* <div className="w-3/5 ml-auto -mr-20 -mt-96 sm1:hidden md:block">
                <Lottie
            ...
            <div className='mt-24'>
                ...
                {/* <div className='absolute mt-[0rem] h-[20rem] w-4/5 left-[10rem] bg-blue-400 rounded-full z-0 blur-[50rem] border-0 border-red-500'></div> */}
