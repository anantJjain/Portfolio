...
const Skill = () => {
  ...
  return (
    <div className='overflow-hidden'>
      <div>
        <div className='flex justify-center w-full font-extrabold text-black bg-blue-400 sm3:p-4 md:text-4xl tracking-tighteruppercase font-stencil-skill3 sm3:text-2xl sm1:text-xl sm1:p-2'>languages & frameworks</div>
        <motion.div
          style={{x}} 
          className='mt-8 font-bold tracking-tighter xl:text-9xl lg:text-8xl leading-2 md:text-7xl sm1:hidden md:block'
        >
            <span className='text-white'>Technological</span>&nbsp;
            <span className='mt-10 font-bold tracking-tighter text-blue-400 font-stencil-skill'>Toolbox.</span>
          <motion.div 
            animate={{
