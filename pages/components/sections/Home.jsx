...
const Home = () => {  
  ...
  return (
    <div className="relative mt-20 border-0 border-black" id="home">
      <div ref={ref2} > 
      <div className='m-auto text-center border-0 border-green-400 mt-28 md:w-4/5 sm1:w-full'>
        ...
        <div className={`border-0 border-blue-500 pt-4 font-bold tracking-tighter text-white font-7 transition duration-300 xl:text-10xl lg:-mt-2 xl:-mt-4 lg:text-8xl sm3:text-7xl md:text-7xl sm1:text-5xl ${ hovering ? '' :'relative' }`}>
      ...
      <motion.div 
        ...
        // animate={{
        //   x: xPosition,
        //   y: yPosition-innerHeight/4,
        // }}
        // transition={{ type:'spring',stiffness:900,damping:900,duration:100}}
      >
        <Image ref={ref} src="/media/mebgrm.png" alt="" width={300} height={200} className={`rounded-2xl sm1:z-10 image-mask md:hidden`}></Image>
        <Image ref={ref} src="/media/mebgrm.png" alt="" width={320} height={200} className={`rounded-2xl image-mask sm1:z-10  sm1:hidden md:block`}></Image>
      </motion.div>
