  ...
  return (
    <div className="relative mt-24 border-0 border-red-500 " id="home">
      ...
      <motion.div 
        ...
        className="relative z-10 flex justify-center m-auto xl:-mt-[28em] cursorChange box-shadow-inside lg:-mt-[24em] md:-mt-[25em] sm3:-mt-[5em] sm2:-mt-[2em] sm1:-mt-[4em] border-0 border-blue-500 sm1:w-3/5 md:w-4/5 xl:w-fit" 
      >
        <Image src="/media/mebgrm.png" alt="" width={300} height={200} className={`rounded-2xl sm1:z-10 image-mask md:hidden ${hovering ? '' : ''} }`}></Image>
        <Image src="/media/mebgrm.png" alt="" width={320} height={200} className={`rounded-2xl image-mask sm1:z-10  sm1:hidden md:block  ${hovering ? '-mt-42' : ''} }`}></Image>
      </motion.div>
